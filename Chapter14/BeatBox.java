...
public class BeatBox 
{
	...
	String[] instrumentNames = {"Bass Drum", "Close Hi-Hat", "Open Hi-Hat", "Acoustic Snare", "Crash Cymbal",
	...
	public class MySendListener implements ActionListener
	{
		public void actionPerformed(ActionEvent a)
		{
			...
			try
			{
				...
				{
					FileOutputStream fileStream = new FileOutputStream(chooser.getSelectedFile());//new File("Checkbox.ser") 
	...
	public class MyReadInListener implements ActionListener
	{
		public void actionPerformed(ActionEvent a)
		{
			...
			try
			{
				...
				if(result == JFileChooser.APPROVE_OPTION)
				{
					FileInputStream filein = new FileInputStream(chooser.getSelectedFile()); //new File("Checkbox.ser")
